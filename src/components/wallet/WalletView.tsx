      ...
      <div className="rounded-3xl bg-gradient-to-br from-[#0F1420] via-[#121A2B] to-[#0A0D14] border border-slate-700/80 p-6 sm:p-8 shadow-2xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            {/* User Transaction Confirmation Hub button */}
            <button
              id="btn-wallet-confirmation-hub"
              onClick={openConfirmationHub}
              className="px-4 py-2 rounded-xl font-bold text-xs text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 active:scale-98 transition-all flex items-center space-x-2 cursor-pointer shadow-sm"
              title="Open User Transaction Confirmation Hub"
            >
              <FileCheck className="w-4 h-4 text-amber-400" />
              <span>Confirmation Hub</span>
            </button>
          </div>
        </div>
