...
export const KycView: React.FC = () => {
  ...
  const currentKycTier = userProfile.kycTier ?? (userProfile.kycStatus === 'tier2_verified' ? 2 : userProfile.kycStatus === 'tier1_verified' ? 1 : 0);
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className={`p-6 rounded-2xl border flex flex-col justify-between space-y-4 shadow-xl ${
          ...
          >
            {currentKycTier >= 2 ? 'Verified (Update Info)' : 'Upgrade to Tier 2'}
          </button>
        </div>
